...
export default function Skills() {
  ...
  const skillCategories = [
    ...
    ['Data Analytics', ['Python', 'R', 'Excel', 'Tableau', 'Power BI']],
    ['DevOps & Tools', ['Git', 'Docker', 'Kubernetes', 'AWS', 'CI/CD', 'Linux']]
  ];

  const categoryImages = {
    'Frontend Development': 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=1000',
  ...
  return (
    <div className="pt-24">
      <div className="container mx-auto px-4 py-12 sm:py-8 mt-20">
        ...
        <p ref={paraRef} className="text-lg text-center text-text-light dark:text-text-dark mb-8 max-w-4xl mx-auto leading-relaxed">
          {t('skills.subtitle')}
        </p>
